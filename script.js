...
body.addEventListener('click',function() {
    ...
    fetch(`http://api.openweathermap.org/data/2.5/weather?q=${input_value.value}&APPID=abd5b263f66694a87d607ad8892804e6`)
    .then((response) => {
...
function addTohtml( data) {
  ...
  let temp_max = (data.main.temp_max - 273.15).toFixed(0);
    ...
    city_weather_name.innerHTML = input_value.value;
